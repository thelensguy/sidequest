 ...
 *
 * <GamificationPanel /> is rendered below purely for manual verification
 * during development (the dashboard isn't wired up to it yet — that
 * happens once the capture/dashboard/gamification branches merge). It's
 * a real, self-fetching component so this isn't throwaway wiring.
 */
export function Options() {
  ...
  return (
    <div style={styles.page}>
      ...
      <section style={styles.section}>
        <h2 style={styles.sectionTitle}>Preview: Quest Log</h2>
        <p style={{ ...styles.subtitle, marginTop: 0 }}>
          Dev-only preview of the gamification panel that will eventually live on the
          dashboard. It fetches its own data, so it reflects real XP/badges/wheel state
          from your event log right now.
        </p>
        <GamificationPanel />
      </section>
    </div>
